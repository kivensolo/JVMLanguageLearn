...
/**
 * 为何与java.io.BufferedInputStream大同小异？？？
 */
public class BufferedInputStream extends FilterInputStream {
	...
	/**
	 * The buffer containing the current bytes read
	 * from the target InputStream.
	 */
	protected volatile byte[] buf;

	/**
	 * The total number of bytes inside the
	 * byte array {@code buf}.
	 */
	protected int count;
	...
	public synchronized boolean isEmpty(){
		byte[] localBuffer = buf;
		return localBuffer == null || localBuffer.length == 0;
	}
