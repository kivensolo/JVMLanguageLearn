...
public class FileUtils {
    ...
    // <editor-fold defaultstate="collapsed" desc="读文件操作">
   ...
   // <editor-fold defaultstate="collapsed" desc="重命名操作">
    /**
     * Rename the file.
     *
     * @param filePath The path of file.
   ...
   // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="判断操作">
    /**
    ...
    // </editor-fold>
   // <editor-fold defaultstate="collapsed" desc="创建操作">
    /**
...
// <editor-fold defaultstate="collapsed" desc="复制操作">
...
// </editor-fold>
  ...
  // <editor-fold defaultstate="collapsed" desc="移动操作">
    /**
     * Move the directory.
     *
     * @param srcDirPath  The path of source directory.
  ...
  // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Md5获取">
    /**
    ...
    /**
     * Check that the text is full of Spaces. eg: "    "
    ...
    private static InputStream loadZipFileIS(String path){
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                byte[] elementByteBuffer = new byte[(int) element.getSize()];
                InputStream inputStream = zipFile.getInputStream(element);
                inputStream.read(elementByteBuffer);
                //TODO 把每个条目数据放到输入流返回
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    private static boolean saveToZipFile(String path, String fileName) {
        if (fileName == null) {
        ...
        try {
            ...
            ZipEntry ze = new ZipEntry("aaaaaaaaaa");
            zos.putNextEntry(ze);
            //写入条目数据
            //zos.write(value.data, value.offset, value.length);
            zos.closeEntry();
            return true;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static String concatPaths(String... paths){
        StringBuilder pathWithSseparator = new StringBuilder();
        for (String path : paths) {
            pathWithSseparator.append(path);
            if(!path.endsWith(File.separator)){
                pathWithSseparator.append(File.separator);
            }
        }
        return pathWithSseparator.toString();
    }
